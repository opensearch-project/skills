...
public class LogPatternAnalysisToolTests {
    ...
    public void testValidate() {
        ...
        assertTrue(tool.validate(Map.of(
            ...
            "selectionTimeRangeEnd", "2025-01-01T01:00:00Z"
        )));
    ...
    public void testLogPatternDiffAnalysis() {
        ...
        tool.run(
            ImmutableMap.of(
                ...
                "baseTimeRangeEnd", "2025-01-01T01:00:00Z",
                "selectionTimeRangeStart", "2025-01-01T01:00:00Z", 
                "selectionTimeRangeEnd", "2025-01-01T02:00:00Z"
            ),
            ActionListener.<String>wrap(
                response -> {
    ...
    public void testExecutionWithNonExistentLogField() {
        ...
        tool.run(
            ImmutableMap.of(
                "index", "test_index",
                "timeField", "@timestamp",
                "logFieldName", "nonexistent_field",
                "selectionTimeRangeStart", "2025-01-01T00:00:00Z",
                "selectionTimeRangeEnd", "2025-01-01T01:00:00Z"
            ),
            ActionListener.<String>wrap(
    ...
    public void testExecutionWithInvalidTimeFormat() {
        ...
        tool.run(
            ImmutableMap.of(
                ...
                "timeField", "@timestamp",
                "logFieldName", "message",
                "selectionTimeRangeStart", "invalid-time-format",
                "selectionTimeRangeEnd", "2025-01-01T01:00:00Z"
            ),
            ActionListener.<String>wrap(
